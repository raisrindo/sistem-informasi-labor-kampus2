    ...
    <div class="row">
        <div class="col-8">
            ...
            <form method="post" action="/employees">
                ...
                <div class="form-group">
                    <label for="posisi">Ruangan</label>
                    <input type="text" class="form-control @error('posisi') is-invalid @enderror" id="posisi" placeholder="Masukkan posisi" name="posisi" value="{{old('posisi')}}">
                    @error('posisi')
                    <div class="invalid-feedback">{{$message}}</div>
                    @enderror
                </div>
